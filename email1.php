...
<nav class="navbar navbar-expand-lg navbar-dark bg-kartki">
  ...
  <h2>WYŚLIJ ŻYCZENIA Z WYBRANĄ KARTKĄ</h2>
...
<form class="page" method="POST">
  ...
  <label class="field field_v1">
    ...
    include('main.inc');
     $sql = "SELECT*FROM uzytkownicy WHERE login = '$x'";
      ...
      echo "<input type='text' name='nazwa' class='field__input' placeholder='poczta@wp.pl' required='required' />";
    }
    ?>
  ...
  <label class="field field_v2">
    <input name="odbiorca" class="field__input" placeholder="poczta@wp.pl" required="required" />
    <span class="field__label-wrap">
      <span class="field__label">do</span>
    </span>
  </label>    
  <label class="field field_v3">
    <input name="temat" class="field__input" placeholder="temat" required="required" />
    <span class="field__label-wrap">
  ...
  <textarea name="tresc" class="field__input" placeholder="Napisz coś" required="required" /></textarea>
    <span  class="field__label-wrap">
