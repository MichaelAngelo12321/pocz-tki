      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <li><a class="dropdown-item " href="kartki_swiateczne.php">Świąteczne</a></li>
            ...
            <li><a class="dropdown-item active" href="kartki_sylwestrowe.php">Sylwestrowe</a></li>
...
<div class="container">
  ...
  <div class="row">
    ...
    <figure>
          <a href="email1.php?b1"><img src="sylwestrowe/kartka1.jpg" alt="Kartka1"></a>
          <figcaption>Kartka 1</figcaption>
        </figure>
    </div>
    <div class="col-md-6 col-sm-12">
    <figure>
    <a href="email1.php?b2"><img src="sylwestrowe/kartka2.jpg" alt="Kartka2"></a>
          <figcaption>Kartka 2</figcaption>
        </figure>
    </div>
    <div class="col-md-6 col-sm-12">
    <figure>
    <a href="email1.php?b3"><img src="sylwestrowe/kartka3.gif" alt="Kartka3"></a>
    ...
    <figure>
    <a href="email1.php?b4"><img src="sylwestrowe/kartka4.jpg" alt="Kartka4"></a>
