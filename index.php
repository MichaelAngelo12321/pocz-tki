  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form method="POST" class="d-flex">
        <input class="form-control me-2" name="pole1" type="login" placeholder="login" aria-label="login">
        <input class="form-control me-2" name="pole2" type="password" placeholder="hasło" aria-label="password">
        <button type="submit" name="s1" class="btn">logowanie</button>
        <button class="btn" type="submit" name="s2">Rejestracja</button>
        </form>
        <?php
        if(isset($_POST['s1'])){
          include('main.inc');
