    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <li><a class="dropdown-item active" href="kartki_swiateczne.php">Świąteczne</a></li>
...
<div class="container">
  ...
  <div class="row">
    ...
    <figure>
          <a href="email1.php?a1" ><img src="swiateczne/kartka1.jpg" alt="Kartka1"></a>
          <figcaption>Kartka 1</figcaption>
        </figure>
    </div>
    <div class="col-md-6 col-sm-12">
    <figure>
    <a href="email1.php?a2"><img src="swiateczne/kartka2.jpg" alt="Kartka2"></a>
          <figcaption>Kartka 2</figcaption>
        </figure>
    </div>
    <div class="col-md-6 col-sm-12">
    <figure>
    <a href="email1.php?a3"><img src="swiateczne/kartka3.jpg" alt="Kartka3"></a>
    ...
    <figure>
    <a href="email1.php?a4"><img src="swiateczne/kartka4.jpg" alt="Kartka4"></a>
