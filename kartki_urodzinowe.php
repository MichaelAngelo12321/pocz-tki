      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <li><a class="dropdown-item " href="kartki_swiateczne.php">Świąteczne</a></li>
            ...
            <li><a class="dropdown-item active" href="kartki_urodzinowe.php">Urodzinowe</a></li>
          </ul>
        </li>
...
<div class="container">
  ...
  <div class="row">
    ...
    <figure>
          <a href="email1.php?c1"><img src="urodzinowe/kartka1.jpg" alt="Kartka1"></a>
          <figcaption>Kartka 1</figcaption>
        </figure>
    </div>
    <div class="col-md-6 col-sm-12">
    <figure>
    <a href="email1.php?c2"><img src="urodzinowe/kartka2.jpg" alt="Kartka2"></a>
          <figcaption>Kartka 2</figcaption>
        </figure>
    </div>
    <div class="col-md-6 col-sm-12">
    <figure>
    <a href="email1.php?c3"><img src="urodzinowe/kartka3.jpg" alt="Kartka3"></a>
    ...
    <figure>
    <a href="email1.php?c4"><img src="urodzinowe/kartka4.gif" alt="Kartka4"></a>
